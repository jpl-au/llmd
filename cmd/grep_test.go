...
func TestGrep(t *testing.T) {
	t.Run("basic match", func(t *testing.T) {
		...
		out := env.run("grep", "authentication")
	...
	t.Run("no match", func(t *testing.T) {
		...
		out := env.run("grep", "NONEXISTENT_TERM_12345")
	...
	t.Run("JSON output", func(t *testing.T) {
		...
		out := env.run("grep", "authentication", "-o", "json")
...
func TestGrep_Scope(t *testing.T) {
	t.Run("path scope docs", func(t *testing.T) {
		env := newTestEnv(t)
		env.runStdin(apiDoc, "write", "docs/api")
...
Line 5`
	...
	t.Run("context lines", func(t *testing.T) {
		env := newTestEnv(t)
		env.runStdin(contextDoc, "write", "docs/test")
...
func TestGrep_Regex(t *testing.T) {
	t.Run("alternation", func(t *testing.T) {
		...
		// Regex alternation should work (this was broken with FTS5)
		out := env.run("grep", "API|TODO")
		env.contains(out, "docs/api")
		env.contains(out, "notes/meeting")
	})
